...
" 'number' shows the absolute line number for your current line.
" 'relativenumber' shows relative (1, 2, 3...) numbers for all other lines.
" This is ideal for Vim navigation (e.g., '5j' to jump down 5 lines).
