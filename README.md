You are right. My apologies. I will fix the paths to ~/.dotfiles and update the README.md with all the new features.

Here is the complete, final, and correct raw text for your README.md file.
...
* **Core Tools Installed**: The setup script attempts to install `nmap`, `gnupg`, `lynis`, `tcpdump`, `trivy`, and `gitleaks`.
    * On **Termux**, `nmap`, `gnupg`, `lynis`, and `tcpdump` are installed successfully.
...
[MIT License](LICENSE.txt)You are right. My apologies. I will fix the paths to ~/.dotfiles and update the README.md with all the new features.
