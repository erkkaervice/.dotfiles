...
3.  **Add Your Fonts:**
    This setup **requires** you to provide your own fonts. The script will *not* download them, but the chosen fonts are included in the repository itself if you wish to use these.
